...
static ConVar	sk_suitcharger( "sk_suitcharger","50" );
static ConVar	sk_suitcharger_citadel( "sk_suitcharger_citadel","50" );
static ConVar	sk_suitcharger_citadel_maxarmor( "sk_suitcharger_citadel_maxarmor","100" );
